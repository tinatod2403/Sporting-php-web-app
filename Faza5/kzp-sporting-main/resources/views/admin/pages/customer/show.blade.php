        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col controls-wrapper mt-3 mt-md-0 d-none d-md-block ">
                            <div class="controls d-flex justify-content-center justify-content-md-end">
                                <a href="{{route('admin.customers.index')}}" class="btn btn-outline-info pull-right mb-3">
                    ...
                    <form
                        action="{{isset($item) ? route('admin.customers.update', ['customer' => $item->id]) : route('admin.customers.store')}}"
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select id="is_active" name="is_active">
                                        <option
                                            value="0" {{(isset($item) && !$item->is_active) || !old('is_active') ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                        <option
                                            value="1" {{(isset($item) && $item->is_active) || old('is_active') ? 'selected' : '' }}>
                                            Active
                                        </option>
                                    </select>
                                </div>
